...
Include both [LANGUAGE.md](LANGUAGE.md) vocabulary and the project glossary (from `engineering:glossary`) in the brief so each sub-agent names things consistently.
...
- User has already committed to a shape from prior work or an ADR.
