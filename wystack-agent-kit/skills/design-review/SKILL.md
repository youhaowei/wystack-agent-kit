...
Load `wystack-agent-kit:frontend` for the design principles and anti-pattern catalog before evaluating.

## Evaluation Dimensions

### 1. AI Slop Detection (First)
Check against the anti-pattern catalog from `wystack-agent-kit:frontend` and `references/anti-patterns.md`. Would someone immediately believe "AI made this"? List specific tells.
