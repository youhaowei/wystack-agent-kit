...
70+ mental models for understanding why people buy, how to influence behavior ethically, and how to make better marketing decisions. Loaded by `copywriter` and `marketing-specialist`.

Mental models are thinking tools. When applying:

1. Identify which models apply to the situation.
2. Explain the psychology behind the model.
3. Provide specific marketing application.
...
These models sharpen strategy and help you solve the right problems.
...
## Five questions to ask before applying a model
