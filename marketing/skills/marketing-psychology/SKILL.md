...
If `.codex/product-marketing-context.md`, `.claude/product-marketing-context.md`, or a similar project-level marketing context file exists, read it before applying mental models. Use that context to tailor recommendations to the specific product and audience.
