...
If `.codex/product-marketing-context.md`, `.claude/product-marketing-context.md`, or a similar project-level marketing context file exists, read it before asking questions. Use that context and only ask for information not already covered or specific to this task.
